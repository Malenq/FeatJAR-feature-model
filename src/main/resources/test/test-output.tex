...
\forestset{
    ...
    groupcardinality/.style 2 args={
        tikz+={
            \path (!c1.parent) coordinate (A) -- (!c.children) coordinate (B) -- (!cl.parent) coordinate (C) pic[
                draw=drawColor,
                angle radius=\angleSizeCardinalityGroup,
                pic text={#1,#2},
                pic text options={
                    scale=0.6,
                    fill=white,
...
,align=ll,abstract,optional[\multicolumn{2}{c}{Feature} \\\hline
\small\texttt{name (String)} &\small\texttt{= Feature} \\
,align=ll,concrete,mandatory,or[\multicolumn{2}{c}{Wonderful} \\\hline
\small\texttt{name (String)} &\small\texttt{= Wonderful} \\
,align=ll,concrete,optional][\multicolumn{2}{c}{Beautiful} \\\hline
\small\texttt{name (String)} &\small\texttt{= Beautiful} \\
,align=ll,concrete,optional]][\multicolumn{2}{c}{World} \\\hline
