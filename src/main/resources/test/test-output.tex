...
\begin{forest}
	featureDiagram
	[Hello,abstract[Feature,concrete,mandatory,or[Wonderful,concrete,optional][Beautiful,concrete,optional]][World,concrete,optional,or]]	
 ...
 \filldraw[drawColor] (0.45,0.15) ++ (225:0.3) arc[start angle=315,end angle=225,radius=0.2]; 
